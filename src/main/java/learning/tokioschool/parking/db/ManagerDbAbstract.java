...
public abstract class ManagerDbAbstract {
	...
	static final String CREATE_TABLE = "CREATE TABLE IF NOT EXISTS Coches (Matricula VARCHAR (10) NOT NULL PRIMARY KEY, Marca VARCHAR (20) NOT NULL, Modelo VARCHAR(20) NOT NULL, HoraEntrada DATETIME NOT NULL, HoraSalida DATETIME)";
	...
	static final String UPDATE = "UPDATE Coches SET HoraSalida=? WHERE Matricula=? AND HoraSalida IS NULL";
	...
	protected Connection iniConexion() throws ClassNotFoundException, SQLException {
		...
		//Connection connection =DataSPoolDB.getConnection();
